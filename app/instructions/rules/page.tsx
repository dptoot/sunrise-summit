...
const ruleSections: RuleSection[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      'Outdoor activities and music should be brought inside after 10:00 PM.',
  ...
  },
  {
    ...
    rules: [
      ...
      'Do not block the garage or turnaround area.',
  ...
  },
  {
    ...
    icon: '🚭',
    rules: [
      'Smoking is strictly prohibited inside the cabin and enclosed areas.',
      'A designated outdoor smoking area is available on the lower deck.',
      'Please use provided ashtrays and dispose of cigarette butts properly.',
  ...
  },
  {
    ...
    rules: [
      ...
      'If pets are approved, a pet fee will apply to your reservation.',
      'Approved pets must be kept off furniture and beds.',
      'Pet owners are responsible for cleaning up after their pets.',
      'Pets must not be left unattended in the cabin.',
      'Any pet damage will be charged to the guest.',
    ],
  },
  {
    title: 'Hot Tub Rules',
    icon: '🛁',
    rules: [
      'No glass containers of any kind in the hot tub area.',
      'Shower before entering the hot tub.',
      'Maximum 6 adults in the hot tub at one time.',
      'Children must be supervised by an adult at all times.',
      'Do not adjust the temperature settings.',
      'Always replace the cover when not in use.',
      'No food or drinks in the hot tub (water bottles are acceptable).',
      'Hot tub is for use by registered guests only.',
    ],
  },
  {
    ...
    rules: [
      ...
      'Start the dishwasher or hand wash and put away dishes.',
      'Take out all trash to the outdoor bins.',
      'Strip beds and leave linens in a pile on each bed.',
      'Set thermostat to 68°F (winter) or 75°F (summer).',
